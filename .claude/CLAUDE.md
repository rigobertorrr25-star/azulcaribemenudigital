# Azul Caribe Lounge — menú digital

## Este proyecto

- Menú digital estático (HTML, CSS y JS sin compilar) publicado en azulcaribelounge.com.
- Platos y precios en `data.js`, traducciones en `i18n.js`, lógica en `app.js`, estilos en `styles.css`. Historial de cambios en `README.txt`.
- `index.html` usa cache-busting (`?v=`): súbelo cuando cambies CSS o JS.
