...
const UI = {
  es: {
    ...
    infoNote: "¿Quieres agregar dirección, horarios o redes sociales aquí? Edítalo fácilmente en <code>index.html</code>, dentro de <code>#info-modal</code>.",
  ...
  en: {
    ...
    infoNote: "Want to add an address, hours, or social links here? Edit it directly in <code>index.html</code>, inside <code>#info-modal</code>.",
  ...
  pt: {
    ...
    infoNote: "Quer adicionar endereço, horários ou redes sociais aqui? Edite diretamente em <code>index.html</code>, dentro de <code>#info-modal</code>.",
